...
//        this.formatter = formatter;
    ...
    public ResponseEntity<?> addChapter(@PathVariable long bookId,
        ...
        TextElements newElements = TextFormatter.parsePatternText(form.getPatternText().trim());
...
//        imageService.createChapterImages(images);
        ...
        System.out.println("Len Text:" + newChapter.getText().length());
        System.out.println("Number:" + newChapter.getChapterNumber());
        newChapter = chapterService.create(newChapter);
...
//        Chapter newChapter = new Chapter();
        ...
        TextElements newElements = TextFormatter.parseHtml(form.getPatternText());
